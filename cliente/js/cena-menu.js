export default class menu extends Phaser.Scene {
  ...
  create() {
    ...
    this.migalha = this.add.sprite(358, 58, "migalha").setScale(2.5);
    ...
    this.setaBarraBaixo = this.physics.add
      .sprite(411, 652, "seta-barra")
      .setScale(0.6)
      .setFlipY(true)
      .setImmovable()
      .setInteractive()
    ...
    this.personagemDireita = this.add
      .sprite(331, 395, "botao-selecionar")
      .setInteractive()
      .on("pointerdown", () => {
    ...
    this.personagemEsquerda = this.add
      .sprite(116, 395, "botao-selecionar")
      .setFlipX(true)
      .setInteractive()
      .on("pointerdown", () => {
    ...
    this.acessorioDireita = this.add
      .sprite(331, 305, "botao-selecionar")
      .setInteractive()
      .on("pointerdown", () => {
    ...
    this.acessorioEsquerda = this.add
      .sprite(116, 305, "botao-selecionar")
      .setFlipX(true)
      .setInteractive()
      .on("pointerdown", () => {
    ...
    this.iniciar = this.add
      .sprite(226, 740, "botao-iniciar")
      .setInteractive()
      .on("pointerdown", () => {
  ...
  atualizarPersonagem() {
    ...
    this.game.estadoPersonagem = {
      spriteId:
        this.personagens[this.game.personagemEscolhido].personagemId +
        "-" +
        this.acessorios[this.game.acessorioEscolhido].acessorioId,
      spritePato:
        "/" +
    ...
    this.textoPersonagem = this.add.text(
      this.personagens[this.game.personagemEscolhido].textoX,
      452,
      this.personagens[this.game.personagemEscolhido].id,
      {
        fontFamily: "Silkscreen",
