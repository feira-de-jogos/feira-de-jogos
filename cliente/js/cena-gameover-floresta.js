...
export default class gameoverFloresta extends Phaser.Scene {
  ...
  create() {
    ...
    this.usuario = this.add
      .text(36, 164, this.usuarioTextoBase, {
        fontFamily: "Silkscreen",
        fontSize: "32px",
        fill: "#cccccc",
      })
    ...
    this.senhaDigitada = "";
    this.senha = this.add
      .text(36, 240, this.senhaTextoBase, {
        fontFamily: "Silkscreen",
        fontSize: "32px",
        fill: "#cccccc",
      })
    ...
    teclado.forEach((digito) => {
      ...
      this.textoTeclado = this.add
        .text(
          108 * ((digito % 3) + 1),
          80 * (Math.floor(digito / 3) + 4.5),
          valor,
          {
            fontFamily: "Silkscreen",
            fontSize: "32px",
        ...
        .on("pointerdown", () => {
          ...
          if (
            this.usuarioDigitado.length === 4 &&
            this.senhaDigitada.length === 4
          ) {
            this.enviar = this.add
              .text(142, 684, "[ENVIAR]", {
                fontFamily: "Silkscreen",
                fontSize: "32px",
                fill: "#ffffff",
              ...
              .on("pointerdown", () => {
                axios
                  .post(
                    "https://feira-de-jogos.sj.ifsc.edu.br/api/v1/credito",
                    {
