...
export default class floresta extends Phaser.Scene {
  ...
  create() {
    ...
    this.cobras.forEach((cobra) => {
      cobra.objeto = this.physics.add
        .sprite(cobra.x, cobra.y, "cobra")
        .setSize(72, 33)
        .setOffset(21, 54)
        .setImmovable()
        .setVisible(false);
    ...
    this.caldeirao = this.physics.add
      .sprite(224, 19130, "caldeirao")
      .setImmovable()
      .setBounce(0)
      .setSize(60, 48)
      .setOffset(2, 10);
    ...
    this.cacique = this.physics.add
      .sprite(403, 19285, "cacique-idle")
      .setSize(52, 40)
      .setOffset(20, 64)
      .setImmovable()
      .setBounce(0);
  ...
  update() {
    ...
    if (this.game.cobrasLiberadas === 1) {
      this.cobras[0].objeto.setVisible(true).setVelocityY(100);
    }
    if (this.game.cobrasLiberadas === 2) {
      this.cobras[1].objeto.setVisible(true).setVelocityY(100);
    }
    if (this.game.cobrasLiberadas === 3) {
      this.cobras[2].objeto.setVisible(true).setVelocityY(100);
    }
    if (this.game.cobrasLiberadas === 4) {
      this.cobras[3].objeto.setVisible(true).setVelocityY(100);
    }
    if (this.game.cobrasLiberadas === 5) {
      this.cobras[4].objeto.setVisible(true).setVelocityY(100);
    }
  }
