...
export default class Cutscene extends Phaser.Scene {
    ...
    this.nadaImage.on("pointerdown", () => {
      ...
      if (this.currentCutscene === this.cutscenes.length - 1) {
        ...
        this.currentCutscene =
          (this.currentCutscene + 1) % this.cutscenes.length;
  ...
  updateCutscene() {
    ...
    this.cutsceneImage = this.add
      .image(400, 225, this.cutscenes[this.currentCutscene].image)
      .setDepth(1);
    ...
    if (this.currentCutscene === 2) {
      // Índice 4 corresponde à cutscene 5
