...
export default class mundoMagico extends Phaser.Scene {
  ...
  create() {
    ...
    this.fantasmasD.forEach((fantasmaD) => {
      fantasmaD.objeto = this.physics.add
        .sprite(fantasmaD.x, fantasmaD.y, "fantasma")
        .setImmovable()
        .setSize(48, 36)
        .setOffset(4, 20)
        .setVelocityX(-150);
    ...
    this.fantasmasE.forEach((fantasmaE) => {
      fantasmaE.objeto = this.physics.add
        .sprite(fantasmaE.x, fantasmaE.y, "fantasma")
        .setImmovable()
        .setSize(48, 36)
        .setOffset(4, 20)
        .setVelocityX(150)
    ...
    this.caldeirao1 = this.physics.add
      .sprite(224, 18928, "caldeirao-mm")
      .setImmovable()
      .setBounce(0)
      .setSize(60, 48)
      .setOffset(2, 10);

    this.caldeirao2 = this.physics.add
      .sprite(224, 12824, "caldeirao-mm")
      .setImmovable()
      .setBounce(0)
      .setSize(60, 48)
      .setOffset(2, 10);
    ...
    this.isa = this.physics.add
      .sprite(73, 12884, "isa-idle")
      .setSize(52, 40)
      .setOffset(20, 64)
      .setImmovable()
      .setBounce(0);
  ...
  danoFantasmasD(fantasmasD) {
    for (let i = 0; i < this.fantasmasD.length; i++) {
      if (!fantasmasD[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.fantasmasD[i].objeto.setSize(48, 36).setOffset(4, 20);
  ...
  danoFantasmasE(fantasmasE) {
    for (let i = 0; i < this.fantasmasE.length; i++) {
      if (!fantasmasE[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.fantasmasE[i].objeto.setSize(48, 36).setOffset(4, 20);
            this.personagemLocal.setAlpha(1);
          },
          delay: 1500,
          callbackScope: this,
