...
export default class campo extends Phaser.Scene {
  ...
  create() {
    ...
    this.vacas.forEach((vaca) => {
      vaca.objeto = this.physics.add
        .sprite(vaca.x, vaca.y, "vaca")
        .setSize(90, 78)
        .setOffset(4, 0)
        .setImmovable();
    ...
    this.tratoresL.forEach((tratorL) => {
      tratorL.objeto = this.physics.add
        .sprite(tratorL.x, tratorL.y, "trator")
        .setImmovable(true)
        .setSize(152, 60)
        .setOffset(0, 30)
        .setVelocityX(-250);
    ...
    this.tratoresD.forEach((tratorD) => {
      tratorD.objeto = this.physics.add
        .sprite(tratorD.x, tratorD.y, "trator")
        .setImmovable(true)
        .setSize(152, 60)
        .setOffset(0, 30);
    ...
    this.tratoresE.forEach((tratorE) => {
      tratorE.objeto = this.physics.add
        .sprite(tratorE.x, tratorE.y, "trator")
        .setImmovable(true)
        .setSize(152, 60)
        .setOffset(0, 30)
        .setFlipX(true);
    ...
    this.caldeirao = this.physics.add
      .sprite(224, 12568, "caldeirao-campo")
      .setImmovable()
      .setBounce(0)
      .setSize(60, 48)
      .setOffset(2, 10);
    ...
    this.pam = this.physics.add
      .sprite(375, 6552, "pam-idle")
      .setSize(52, 40)
      .setOffset(20, 64)
      .setImmovable(true)
      .setBounce(0);
  ...
  update() {
    ...
    if (this.game.tratoresELiberados === 1) {
      this.tratoresE[0].objeto.setVelocityX(250);
    }
