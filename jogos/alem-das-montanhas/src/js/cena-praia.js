...
export default class praia extends Phaser.Scene {
  ...
  create() {
    ...
    this.layerTronco01 = this.tilemapMapa.createLayer("tronco-01", [
      this.tilesetGeral,
    ]);
    this.layerPedra = this.tilemapMapa.createLayer("pedra", [
      this.tilesetGeral,
    ]);
    this.layerNaFrente03 = this.tilemapMapa.createLayer("naFrente-03", [
      this.tilesetGeral,
    ]);
    this.layerLapideF04 = this.tilemapMapa.createLayer("lapideF-04", [
      this.tilesetGeral,
    ]);
    this.layerOssos1 = this.tilemapMapa.createLayer("ossos1", [
      this.tilesetGeral,
    ]);
    this.layerOssos2 = this.tilemapMapa.createLayer("ossos2", [
      this.tilesetGeral,
    ]);
    this.layerCercaF = this.tilemapMapa.createLayer("cercaF", [
      this.tilesetGeral,
    ]);
    this.layerCasteloF = this.tilemapMapa.createLayer("casteloF", [
      this.tilesetGeral,
    ]);
    ...
    this.migalhas.forEach((migalha) => {
      migalha.objeto = this.physics.add
        .sprite(migalha.x, migalha.y, "migalha")
        .setImmovable();
    ...
    this.caranguejosD.forEach((caranguejoD) => {
      caranguejoD.objeto = this.physics.add
        .sprite(caranguejoD.x, caranguejoD.y, "caranguejo")
        .setImmovable(true)
        .setVelocityX(-350);
    ...
    this.caranguejosE.forEach((caranguejoE) => {
      caranguejoE.objeto = this.physics.add
        .sprite(caranguejoE.x, caranguejoE.y, "caranguejo")
        .setImmovable(true)
        .setVelocityX(350);
    ...
    this.caranguejosCB.forEach((caranguejoCB) => {
      caranguejoCB.objeto = this.physics.add
        .sprite(caranguejoCB.x, caranguejoCB.y, "caranguejo")
        .setImmovable(true)
        .setVisible(false);
    ...
    this.caranguejosBC.forEach((caranguejoBC) => {
      caranguejoBC.objeto = this.physics.add
        .sprite(caranguejoBC.x, caranguejoBC.y, "caranguejo")
        .setImmovable(true)
    ...
    this.tucano = this.physics.add
      .sprite(84, 176, "tucano-idle")
      .setSize(52, 40)
      .setOffset(20, 64)
      .setImmovable()
      .setBounce(0);
    ...
    this.caixaDeSom = this.physics.add
      .sprite(20, 212, "caixa-de-som")
      .setImmovable()
      .setBounce(0)
      .setSize(40, 50);

    this.caixaDeSom2 = this.physics.add
      .sprite(146, 212, "caixa-de-som")
      .setImmovable()
      .setBounce(0)
      .setSize(40, 50)
      .setFlipX(true);
    ...
    if (this.game.jogadores.primeiro === this.game.socket.id) {
      ...
      if (
        this.game.estadoPersonagem.spritePato ===
        this.game.estadoPersonagemRemoto.spritePato
      ) {
    ...
    this.layerAtras03 = this.tilemapMapa.createLayer("atras-03", [
      this.tilesetGeral,
    ]);
    this.layerCopaT01 = this.tilemapMapa.createLayer("copaT-01", [
      this.tilesetGeral,
    ]);
    this.layerCopaF01 = this.tilemapMapa.createLayer("copaF-01", [
      this.tilesetGeral,
    ]);
    this.layerLapideT04 = this.tilemapMapa.createLayer("lapideT-04", [
      this.tilesetGeral,
    ]);
    this.layerCercaT = this.tilemapMapa.createLayer("cercaT", [
      this.tilesetGeral,
    ]);
    this.layerCasteloT = this.tilemapMapa.createLayer("casteloT", [
      this.tilesetGeral,
    ]);
    ...
    this.texto = this.add.text(
      26,
      68,
      `Migalhas: ${this.game.scoreMigalha.score}`,
      {
    ...
    this.coracoes = this.add
      .sprite(100, 42, "coracoes")
      .setScale(1.5)
      .setScrollFactor(0, 0);
    ...
    this.cima = this.add
      ...
      .on("pointerout", () => {
        ...
        if (
          this.cima.frame.name === 0 &&
          this.baixo.frame.name === 0 &&
          this.direita.frame.name === 0 &&
          this.esquerda.frame.name === 0
        ) {
  ...
  update() {
    ...
    if (this.game.caranguejosCBLiberados === 1) {
      this.caranguejosCB[0].objeto.setVisible(true).setVelocityY(200);
    }
    if (this.game.caranguejosCBLiberados === 2) {
      this.caranguejosCB[1].objeto.setVisible(true).setVelocityY(200);
    }
  ...
  danoCaranguejosD(caranguejosD) {
    for (let i = 0; i < this.caranguejosD.length; i++) {
      if (!caranguejosD[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.caranguejosD[i].objeto.setSize(34, 18).setOffset(0, 0);
  ...
  danoCaranguejosE(caranguejosE) {
    for (let i = 0; i < this.caranguejosE.length; i++) {
      if (!caranguejosE[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.caranguejosE[i].objeto.setSize(34, 18).setOffset(0, 0);
            this.personagemLocal.setAlpha(1);
          },
          delay: 750,
          callbackScope: this,
  ...
  danoCaranguejosCB(caranguejosCB) {
    for (let i = 0; i < this.caranguejosCB.length; i++) {
      if (!caranguejosCB[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.caranguejosCB[i].objeto.setSize(34, 18).setOffset(0, 0);
            this.personagemLocal.setAlpha(1);
          },
          delay: 1500,
          callbackScope: this,
  ...
  danoCaranguejosBC(caranguejosBC) {
    for (let i = 0; i < this.caranguejosBC.length; i++) {
      if (!caranguejosBC[i]) {
        ...
        this.time.addEvent({
          callback: () => {
            this.caranguejosBC[i].objeto.setSize(34, 18).setOffset(0, 0);
            this.personagemLocal.setAlpha(1);
          },
          delay: 1500,
          callbackScope: this,
