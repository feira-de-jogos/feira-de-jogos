...
export default class mapa extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "BlocosCenarioAmarelo",
      "./assets/mapa/BlocosCenarioAmarelo.png",
    );
    this.load.image(
      "BlocosCenarioVermelho",
    ...
    this.load.spritesheet("LeoVen", "./assets/personagens/LeoVen.png", {
      frameWidth: 48,
      frameHeight: 48,
    });
    this.load.spritesheet("BenVen", "./assets/personagens/BenVen.png", {
      frameWidth: 48,
      frameHeight: 48,
    });
    this.load.spritesheet("monstro", "./assets/personagens/monstro.png", {
      frameWidth: 64,
      frameHeight: 64,
    });
    this.load.spritesheet("ogrogelo", "./assets/personagens/ogrogelo.png", {
      frameWidth: 75,
      frameHeight: 105,
    });
    this.load.spritesheet(
      ...
      { frameWidth: 75, frameHeight: 105 },
    );
    this.load.spritesheet("ogrofogo", "./assets/personagens/ogrofogo.png", {
      frameWidth: 75,
      frameHeight: 105,
    });
    this.load.spritesheet("ogroroxo", "./assets/personagens/ogroroxo.png", {
      frameWidth: 75,
      frameHeight: 105,
    });
    this.load.spritesheet(
    ...
    this.load.spritesheet("bau", "./assets/spritesmapa/bau.png", {
      frameWidth: 110,
      frameHeight: 100,
    });
    ...
    this.load.spritesheet("PortaBoss", "./assets/spritesmapa/PortaBoss.png", {
      frameWidth: 96,
      frameHeight: 96,
    });
    this.load.spritesheet(
    ...
    // Sprites Botoes
    this.load.spritesheet("cima", "./assets/Controles/SetaCima.png", {
      frameWidth: 128,
      frameHeight: 128,
    });
    this.load.spritesheet("esquerda", "./assets/Controles/SetaEsq.png", {
      frameWidth: 128,
      frameHeight: 128,
    });
    this.load.spritesheet("direita", "./assets/Controles/SetaDir.png", {
      frameWidth: 128,
      frameHeight: 128,
    });
  }
  ...
  create() {
    ...
    this.tilesetBlocosCenarioVerde =
      this.tilemapMapa.addTilesetImage("BlocosCenarioVerde");
    this.tilesetBlocosCenarioAmarelo = this.tilemapMapa.addTilesetImage(
      "BlocosCenarioAmarelo",
    );
    this.tilesetBlocosCenarioVermelho = this.tilemapMapa.addTilesetImage(
      "BlocosCenarioVermelho",
    );
    this.tilesetBlocosCenarioAzul =
      this.tilemapMapa.addTilesetImage("BlocosCenarioAzul");
    this.tilesetBlocosCenarioRoxo =
      this.tilemapMapa.addTilesetImage("BlocosCenarioRoxo");
    ...
    this.tilesetFundoCavernaAzul =
      this.tilemapMapa.addTilesetImage("FundoCavernaAzul");
    this.tilesetFundoCavernaRoxa =
      this.tilemapMapa.addTilesetImage("FundoCavernaRoxa");
    this.tilesetFundoCavernaVerde =
      this.tilemapMapa.addTilesetImage("FundoCavernaVerde");
    this.tilesetFundoCavernaVermelho = this.tilemapMapa.addTilesetImage(
      "FundoCavernaVermelho",
    );
    this.tilesetFundoCavernaAmarela = this.tilemapMapa.addTilesetImage(
      "FundoCavernaAmarela",
    );
    this.tilesetGramas = this.tilemapMapa.addTilesetImage("Gramas");
    this.tilesetGramasAmarela =
      this.tilemapMapa.addTilesetImage("GramasAmarela");
    this.tilesetGramasAzul = this.tilemapMapa.addTilesetImage("GramasAzul");
    this.tilesetGramasVermelho =
      this.tilemapMapa.addTilesetImage("GramasVermelho");
    ...
    this.layerFundo = this.tilemapMapa.createLayer("Fundo", [
      ...
      this.tilesetFundoCavernaRoxa,
      this.tilesetFundoCavernaVerde,
      this.tilesetFundoCavernaVermelho,
      this.tilesetFundoCavernaAmarela,
      this.tilesetBlocosBordas,
      this.tilesetinicio,
      this.tilesetarenaboss,
    ]);
    this.layerChao = this.tilemapMapa.createLayer("Chao", [
      this.tilesetBlocosCenarioVerde,
      this.tilesetBlocosCenarioAmarelo,
      this.tilesetBlocosCenarioVermelho,
      this.tilesetBlocosCenarioAzul,
      this.tilesetBlocosCenarioRoxo,
      this.tilesetpedra,
      this.tilesetBlocosTeto,
    ]);
    this.layerParedes = this.tilemapMapa.createLayer("Paredes", [
      this.tilesetBlocosTeto,
      this.tilesetpedra,
    ]);
    this.layerObstaculos = this.tilemapMapa.createLayer("Obstaculos", [
      this.tilesetBlocosMorte,
    ]);
    ...
    this.altarcristalamarelo = this.physics.add.sprite(
      7113,
      2600,
      "altarcristalamarelo",
    );
    ...
    // Altar Cristal Fogo:
    this.altarcristalfogo = this.physics.add.sprite(
      3030,
      4200,
      "altarcristalfogo",
    );
    ...
    // Altar Cristal Gelo:
    this.altarcristalgelo = this.physics.add.sprite(
      3798,
      613,
      "altarcristalgelo",
    );
    ...
    // Altar Cristal Roxo:
    this.altarcristalroxo = this.physics.add.sprite(
      1623,
      1570,
      "altarcristalroxo",
    );
    ...
    this.layerDetalhes = this.tilemapMapa.createLayer("Detalhes", [
      this.tilesetPedrinhas,
      this.tilesetGramas,
      this.tilesetGramasAmarela,
      this.tilesetGramasAzul,
      this.tilesetGramasVermelho,
      this.tilesetGramasRoxo,
    ]);
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("dragaozinho", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("dragaozinhofogo", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("dragaozinhogelo", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("dragaozinhoroxo", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("dragaozinhoverde", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("ogroamarelo", {
        start: 0,
        end: 3,
      }),
      frameRate: 5,
    ...
    this.anims.create({
      key: "PortaBoss",
      frames: this.anims.generateFrameNumbers("PortaBoss", {
        start: 0,
        end: 8,
      }),
      frameRate: 3,
    ...
    this.cima = this.add
      ...
      .on("pointerover", () => {
        ...
        if (this.personagemLocal.body.blocked.down) {
          ...
          this.personagemLocal.anims
            .play("pulando_" + this.personagemLado)
    ...
    // cristal amarelo
    this.cristalamarelo = this.add
      .sprite(820, 30, "cristalamarelo", 0)
      .setVisible(false)
      .setScrollFactor(0)
      .setInteractive()
      .setScale(3);
    // cristal vermelho
    this.cristalvermelho = this.add
      .sprite(780, 30, "cristalvermelho", 0)
      .setVisible(false)
      .setScrollFactor(0)
      .setInteractive()
      .setScale(3);
    // cristal azul
    this.cristalazul = this.add
      .sprite(740, 30, "cristalazul", 0)
      .setVisible(false)
      .setScrollFactor(0)
      .setInteractive()
      .setScale(3);
    // cristal roxo
    this.cristalroxo = this.add
      .sprite(700, 30, "cristalroxo", 0)
      .setVisible(false)
      .setScrollFactor(0)
      .setInteractive()
      .setScale(3);
    ...
    this.ogros.forEach((ogro) => {
      ...
      ogro.blocoDireita = this.physics.add.sprite(
        ogro.direita.x,
        ogro.direita.y,
        "Vazio",
      );
      ogro.blocoDireita.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        ogro.objeto,
        ogro.blocoDireita,
        () => {
      ...
      ogro.blocoEsquerda = this.physics.add.sprite(
        ogro.esquerda.x,
        ogro.esquerda.y,
        "Vazio",
      );
      ogro.blocoEsquerda.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        ogro.objeto,
        ogro.blocoEsquerda,
        () => {
    ...
    this.dragaozinho.forEach((dragaozinho) => {
      dragaozinho.objeto = this.physics.add.sprite(
        dragaozinho.x,
        dragaozinho.y,
        dragaozinho.sprite,
      );
      dragaozinho.objeto.body.setAllowGravity(false); // Disable gravity for dragaozinho
      dragaozinho.blocoDireita = this.physics.add.sprite(
        dragaozinho.direita.x,
        dragaozinho.direita.y,
        "Vazio",
      );
      dragaozinho.blocoDireita.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        dragaozinho.objeto,
        dragaozinho.blocoDireita,
        () => {
          dragaozinho.objeto.anims.play(
            dragaozinho.sprite + "_voando_esquerda",
          );
      ...
      dragaozinho.blocoEsquerda = this.physics.add.sprite(
        dragaozinho.esquerda.x,
        dragaozinho.esquerda.y,
        "Vazio",
      );
      dragaozinho.blocoEsquerda.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        dragaozinho.objeto,
        dragaozinho.blocoEsquerda,
        () => {
    ...
    this.monstros.forEach((monstro) => {
      monstro.objeto = this.physics.add.sprite(
        monstro.x,
        monstro.y,
        monstro.sprite,
      );

      monstro.blocoDireita = this.physics.add.sprite(
        monstro.direita.x,
        monstro.direita.y,
        "Vazio",
      );
      monstro.blocoDireita.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        monstro.objeto,
        monstro.blocoDireita,
        () => {
      ...
      monstro.blocoEsquerda = this.physics.add.sprite(
        monstro.esquerda.x,
        monstro.esquerda.y,
        "Vazio",
      );
      monstro.blocoEsquerda.body.setAllowGravity(false).setImmovable(true);
      this.physics.add.collider(
        monstro.objeto,
        monstro.blocoEsquerda,
        () => {
    ...
    if (this.personagemLocal) {
      this.physics.add.overlap(this.personagemLocal, this.PortaBoss, () => {
        if (
          this.cristalamarelo.visible &&
          this.cristalazul.visible &&
          this.cristalvermelho.visible &&
          this.cristalroxo.visible
        ) {
          ...
          this.PortaBoss.anims.currentFrame &&
          this.PortaBoss.anims.currentFrame.index === 8
        ) {
