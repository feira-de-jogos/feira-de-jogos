...
export default class mapa extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("mago", "./assets/personagens/mago.png", {
      frameWidth: 48,
      frameHeight: 59,
    });
    this.load.spritesheet("menino", "./assets/personagens/menino.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("menina", "./assets/personagens/menina.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet("blocoquebra", "./assets/animacoes/blocoquebra.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("armadilha", "./assets/animacoes/armadilha.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet(
    ...
    this.load.spritesheet("aranha", "./assets/inimigos/aranha.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("bat", "./assets/inimigos/bat.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("slime", "./assets/inimigos/slime.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet("beyblade", "./assets/inimigos/beyblade.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("cristal", "./assets/animacoes/cristal.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("grade", "./assets/animacoes/grade.png", {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet("botaograde", "./assets/animacoes/botaograde.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("pocaorosa", "./assets/animacoes/pocaorosa.png", {
      frameWidth: 28,
      frameHeight: 56,
    });
    this.load.spritesheet("pocaoverde", "./assets/animacoes/pocaoverde.png", {
      frameWidth: 28,
      frameHeight: 56,
    });
    this.load.spritesheet("pocaoazul", "./assets/animacoes/pocaoazul.png", {
      frameWidth: 28,
      frameHeight: 56,
    });
    this.load.spritesheet("pocaoverme", "./assets/animacoes/pocaoverme.png", {
      frameWidth: 28,
      frameHeight: 56,
    });
    this.load.spritesheet("agua", "./assets/animacoes/agua.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("aguaborda", "./assets/animacoes/aguaborda.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet("buraco", "./assets/buraco.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("blocovazio", "./assets/blocovazio.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("blocovazio2", "./assets/blocovazio2.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("blocovazio3", "./assets/blocovazio3.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("blocovazio4", "./assets/blocovazio4.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("blocovazio5", "./assets/blocovazio5.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
  ...
  create() {
    ...
    this.layerchaofaltando = this.tilemapMapa.createLayer("chaofaltando", [
      this.tilesetFloresta,
    ]);
    // Animações agua
    this.anims.create({
    ...
    this.rioborda.forEach((aguaborda) => {
      aguaborda.objeto = this.physics.add.sprite(
        aguaborda.x,
        aguaborda.y,
        "aguaborda",
      );
    ...
    this.layerchao = this.tilemapMapa.createLayer("chao", [
      this.tilesetFloresta,
      this.tilesetMasmorra,
    ]);
    this.layerparedemsm = this.tilemapMapa.createLayer("paredemsm", [
      this.tilesetMasmorra,
    ]);
    this.layerarbustos = this.tilemapMapa.createLayer("arbustos", [
      this.tilesetFloresta,
      this.tilesetMasmorra,
      this.tilesetMoveisbruxa,
      this.tilesetTorre,
    ]);
    this.layerflores = this.tilemapMapa.createLayer("flores", [
      this.tilesetFloresta,
    ]);
    ...
    this.blocosquebra.forEach((blocoquebra) => {
      blocoquebra.objeto = this.physics.add.sprite(
        blocoquebra.x,
        blocoquebra.y,
        "blocoquebra",
      );
    ...
    this.armadilhas.forEach((armadilha) => {
      armadilha.objeto = this.physics.add.sprite(
        armadilha.x,
        armadilha.y,
        "armadilha",
      );
    ...
    this.armadilhasfake.forEach((armadilhafake) => {
      armadilhafake.objeto = this.physics.add.sprite(
        armadilhafake.x,
        armadilhafake.y,
        "armadilhafake",
      );
    ...
    this.fantasmas.forEach((fantasma) => {
      fantasma.sprite = this.physics.add.sprite(
        fantasma.x,
        fantasma.y,
        "fantasma",
      );
    ...
    this.anims.create({
      key: "beyblade-ataque",
      frames: this.anims.generateFrameNumbers("beyblade", {
        start: 8,
        end: 10,
      }),
      frameRate: 12,
    ...
    this.beyblades.forEach((beyblade) => {
      beyblade.sprite = this.physics.add.sprite(
        beyblade.x,
        beyblade.y,
        "beyblade",
      );
    ...
    this.botaograde.colisao = this.physics.add.overlap(
      this.personagemLocal,
      this.botaograde,
      () => {
        this.game.dadosJogo.send(
          JSON.stringify({ botaoGradePressionado: true }),
        );
    ...
    this.blocosquebra.forEach((blocoquebra) => {
      blocoquebra.overlap = this.physics.add.overlap(
        this.personagemLocal,
        blocoquebra.objeto,
        () => {
          this.hurt.play();
    ...
    this.armadilhas.forEach((armadilha) => {
      armadilha.overlap = this.physics.add.overlap(
        this.personagemLocal,
        armadilha.objeto,
        () => {
          if (armadilha.objeto.anims.currentFrame.index >= 17) {
    ...
    this.buracos.forEach((buraco) => {
      buraco.overlap = this.physics.add.overlap(
        this.personagemLocal,
        buraco.objeto,
        () => {
          this.hurt.play();
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("pocaorosa", {
        start: 0,
        end: 5,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("pocaoverde", {
        start: 0,
        end: 5,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("pocaoazul", {
        start: 0,
        end: 5,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers("pocaoverme", {
        start: 0,
        end: 5,
      }),
      frameRate: 10,
    ...
    this.pocaorosa.overlap = this.physics.add.overlap(
      this.personagemLocal,
      this.pocaorosa,
      () => {
        this.coletar2.play();
    ...
    this.pocaoverde.overlap = this.physics.add.overlap(
      this.personagemLocal,
      this.pocaoverde,
      () => {
        this.coletar2.play();
    ...
    this.pocaoazul.overlap = this.physics.add.overlap(
      this.personagemLocal,
      this.pocaoazul,
      () => {
        this.coletar2.play();
    ...
    this.pocaoverme.overlap = this.physics.add.overlap(
      this.personagemLocal,
      this.pocaoverme,
      () => {
        this.coletar2.play();
    ...
    this.physics.add.overlap(
      ...
      this.blocovazio,
      () => {
        this.game.dadosJogo.send(JSON.stringify({ aranhasAndam: true }));
    ...
    this.physics.add.overlap(
      ...
      this.blocovazio2,
      () => {
        this.game.dadosJogo.send(JSON.stringify({ batsAndam: true }));
        this.batsAndam = true;
      },
      null,
      this,
    ...
    this.physics.add.overlap(
      ...
      this.blocovazio3,
      () => {
        this.game.dadosJogo.send(JSON.stringify({ slimesAndam: true }));
    ...
    this.physics.add.overlap(
      ...
      () => {
        this.game.dadosJogo.send(
          JSON.stringify({ fantasmasAndam: true }),
        );
    ...
    this.physics.add.overlap(
      ...
      () => {
        this.game.dadosJogo.send(
          JSON.stringify({ beybladesAndam: true }),
        );
    ...
    this.aranhas.forEach((aranha) => {
      aranha.colisao = this.physics.add.overlap(
        aranha.sprite,
        this.personagemLocal,
        () => {
    ...
    this.bats.forEach((bat) => {
      bat.colisao = this.physics.add.overlap(
        bat.sprite,
        this.personagemLocal,
        () => {
    ...
    this.slimes.forEach((slime) => {
      slime.colisao = this.physics.add.overlap(
        slime.sprite,
        this.personagemLocal,
        () => {
    ...
    this.fantasmas.forEach((fantasma) => {
      fantasma.colisao = this.physics.add.overlap(
        fantasma.sprite,
        this.personagemLocal,
        () => {
    ...
    this.beyblades.forEach((beyblade) => {
      beyblade.colisao = this.physics.add.overlap(
        beyblade.sprite,
        this.personagemLocal,
        () => {
    ...
    this.layerpersonagempassa = this.tilemapMapa.createLayer(
      "personagempassa",
      [this.tilesetFloresta, this.tilesetMasmorra],
    );
    this.layertorre = this.tilemapMapa.createLayer("torre", [
      this.tilesetTorre,
    ]);

    this.vida = this.add.sprite(220, 100, "vida", 0).setScrollFactor(0);
    ...
    this.cristais.forEach((cristal) => {
      ...
      cristal.overlap = this.physics.add.overlap(
        this.personagemLocal,
        cristal.objeto,
        () => {
          this.coletar.play();
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers(
        this.personagemLocal.texture.key + "ataque",
        { start: 0, end: 5 },
      ),
      frameRate: 12,
    });
    ...
    this.botao = this.add
      ...
      .on("pointerdown", () => {
        ...
        this.personagemLocal.anims
          .play("personagem-ataque-" + this.direcaoAtual)
  ...
  update() {
      ...
      if (this.game.dadosJogo.readyState === "open") {
        ...
        if (this.personagemLocal) {
          ...
          if (this.cristais) {
            this.game.dadosJogo.send(
              JSON.stringify({
                cristais: this.cristais.map((cristal) =>
                  ((cristal) => ({
          ...
          if (this.aranhas) {
            this.game.dadosJogo.send(
              JSON.stringify({
                aranhas: this.aranhas.map((aranha) =>
                  ((aranha) => ({
          ...
          if (this.fantasmas) {
            this.game.dadosJogo.send(
              JSON.stringify({
                fantasmas: this.fantasmas.map((fantasma) =>
                  ((fantasma) => ({
          ...
          if (this.beyblades) {
            this.game.dadosJogo.send(
              JSON.stringify({
                beyblades: this.beyblades.map((beyblade) =>
                  ((beyblade) => ({
        ...
        this.pontos.setText(
          "cristais: " +
            this.cristais.filter((cristal) => !cristal.objeto.active).length +
            "/40",
        );
      }
    } catch (error) {
    ...
    const cristaisColetados = this.cristais.filter(
      (cristal) => !cristal.objeto.active,
    ).length;
  ...
  checkTeleport() {
    ...
    if (this.personagemLocal.x === 3824 && this.personagemLocal.y === 656) {
      ...
      this.personagemLocal.x >= 412 &&
      this.personagemLocal.x <= 456 &&
      this.personagemLocal.y === 1392
    ) {
